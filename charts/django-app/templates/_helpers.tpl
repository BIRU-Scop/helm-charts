...
Caddy labels
*/}}
{{- define "django-app.caddyLabels" -}}
app.kubernetes.io/name: {{ include "django-app.name" . }}-caddy
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
...
worker labels
*/}}
{{- define "django-app.workerLabels" -}}
app.kubernetes.io/name: {{ include "django-app.name" . }}-worker
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
